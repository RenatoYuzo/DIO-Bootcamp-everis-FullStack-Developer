...
public class Desafio5 {
	...
	private static Integer[][] realizarOperacao1(Map<String, Integer> operacao, Integer[][] tabuleiro, int tamTab) {
		for (int i = 0; i < tamTab; i++) {
	...
	private static Integer[][] realizarOperacao2(Map<String, Integer> operacao, Integer[][] tabuleiro, int tamTab) {
		for (int i = 0; i < tamTab; i++) {
	...
	private static Map<Integer, Integer> lerRepeticoesLinhaX(Map<String, Integer> operacao, Integer[][] tabuleiro, Integer tamTab) {
	...
	private static Map<Integer, Integer> lerRepeticoesColunaX(Map<String, Integer> operacao, Integer[][] tabuleiro, Integer tamTab) {
